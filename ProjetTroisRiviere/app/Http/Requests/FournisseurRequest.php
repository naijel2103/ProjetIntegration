...
class FournisseurRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'rue' => 'nullable|string|max:64',  // La rue est requise et doit être une chaîne de max 64 caractères
            ...
            'detailService' => 'string|max:500',  // Les détails du service sont optionnels et peuvent avoir jusqu'à 500 caractères
            ...
            'statut' => 'string|max:25',  // Le statut est optionnel et peut avoir jusqu'à 25 caractères
        ];
    }
}
